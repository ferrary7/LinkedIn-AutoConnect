...
const connectionRequestsCountSpan = document.getElementById('connectionCount')
const autoConnectBtn = document.getElementById('autoConnect')
autoConnectBtn.onclick = async function () {
  isAutoConnecting = ! isAutoConnecting
  if (isAutoConnecting) {
    autoConnectBtn.textContent = 'Stop Connecting Automatically🥲'
  } else {
    autoConnectBtn.textContent = 'Start Connecting Automatically😉'
  }
